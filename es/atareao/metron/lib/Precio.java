 ...
 */
public class Precio extends WrapperTable<Precio>{
    // <editor-fold defaultstate="collapsed" desc=" Constantes  "> 

    // </editor-fold> 

    // <editor-fold defaultstate="collapsed" desc=" Constructores  "> 
    public Precio() throws SQLException{
        this(null);
    }
    public Precio(Conector conector) throws SQLException {
        super(Precio.class,conector,"public","precio");
        ...
        this.addValidator(new NotEmptyValidator(this,"precio"));
        this.addValidator(new NotNullValidator(this,"precio"));

 ...
 */
public class Texto extends WrapperTable<Texto>{
    // <editor-fold defaultstate="collapsed" desc=" Constantes  "> 

    // </editor-fold> 

    // <editor-fold defaultstate="collapsed" desc=" Constructores  "> 
    public Texto() throws SQLException{
        this(null);
    }
    public Texto(Conector conector) throws SQLException {
        super(Texto.class,conector,"public","texto");

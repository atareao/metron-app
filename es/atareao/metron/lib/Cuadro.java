 ...
 */
public class Cuadro extends WrapperTable<Cuadro>{
    // <editor-fold defaultstate="collapsed" desc=" Constantes  "> 

    // </editor-fold> 

    // <editor-fold defaultstate="collapsed" desc=" Constructores  "> 
    public Cuadro() throws SQLException{
        this(null);
    }
    public Cuadro(Conector conector) throws SQLException {
        super(Cuadro.class,conector,"public","cuadro");
